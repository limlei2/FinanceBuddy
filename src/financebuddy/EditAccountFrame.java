...
public class EditAccountFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonEnter.setFont(new java.awt.Font("Product Sans", 0, 18)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(jLabelFinanceBuddy, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void jButtonEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEnterActionPerformed
        ...
        try{
            if(password.equals(password2)){
                ...
                ResultSet rs = stmt.executeQuery("select password from users where username like '"+username+"'");
                rs.first();
                String oldpass = String.valueOf(rs.getObject(1));
                if(oldpass.equals(password)) {
                    JOptionPane.showMessageDialog(null, "Please enter a new password.");
                }
                else {
                    stmt = con.createStatement();
                    stmt.executeUpdate("UPDATE users SET password = '"+password+"' WHERE username LIKE '"+username+"'"); 
                    JOptionPane.showMessageDialog(null, "Password Changed!");
                    JOptionPane.showMessageDialog(null, "Program will restart. Please login again.");
